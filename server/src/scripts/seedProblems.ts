...
Return the maximum profit you can achieve from this transaction. If you cannot achieve any profit, return \`0\`.`,
    ...
    testCases: [
      ...
      { input: '[3,3,3,3,3]', expectedOutput: '0', isHidden: true },
...
An **anagram** is a word or phrase formed by rearranging the letters of a different word or phrase, using all the original letters exactly once.`,
    ...
    testCases: [
      ...
      { input: '"aaa"\n"aaa"', expectedOutput: 'true', isHidden: true },
...
5. Clamp to 32-bit signed integer range [-2^31, 2^31 - 1].`,
    ...
    testCases: [
      ...
      { input: '"  +123"', expectedOutput: '123', isHidden: true },
  ...
  },
  {
    ...
    testCases: [
      ...
      { input: '"abc"\n"ac"', expectedOutput: 'abc', isHidden: true },
...
Each letter in \`magazine\` can only be used once in \`ransomNote\`.`,
    ...
    testCases: [
      ...
      { input: '"bg"\n"efjbdfbdgfjhhaiigfhbaejahgfbbgbjagbddfgdiaigd"', expectedOutput: 'true', isHidden: true },
      { input: '"abc"\n"ab"', expectedOutput: 'false', isHidden: true },
...
An anagram is a word or phrase formed by rearranging the letters of a different word or phrase, using all the original letters exactly once.`,
    ...
    testCases: [
      ...
      { input: '["a"]', expectedOutput: '[["a"]]', isHidden: true },
      { input: '["abc","bca","cab","xyz","zyx"]', expectedOutput: '[["abc","bca","cab"],["xyz","zyx"]]', isHidden: true },
      { input: '["",""]', expectedOutput: '[["",""]]', isHidden: true },
      { input: '["ab","ba","cd","dc","ef"]', expectedOutput: '[["ab","ba"],["cd","dc"],["ef"]]', isHidden: true },
  ...
  },
  {
    ...
    testCases: [
      ...
      { input: '[1,2,2,3,3,3]\n2', expectedOutput: '[3,2]', isHidden: true },
...
A subarray is a contiguous non-empty sequence of elements within an array.`,
  ...
  // ============================================
  {
    ...
    testCases: [
      ...
      { input: '[7,8,9,10]', expectedOutput: '[10,9,8,7]', isHidden: true },
...
Return the head of the merged linked list.`,
    ...
    testCases: [
      ...
      { input: '[2,5,8]\n[1,3,6,9]', expectedOutput: '[1,2,3,5,6,8,9]', isHidden: true },
...
Return \`true\` if there is a cycle in the linked list. Otherwise, return \`false\`.`,
  ...
  },
  {
    ...
    testCases: [
      ...
      { input: '[1,2,3]\n3', expectedOutput: '[2,3]', isHidden: true },
      { input: '[1,2,3,4,5,6,7]\n4', expectedOutput: '[1,2,3,5,6,7]', isHidden: true },
...
You may not modify the values in the list's nodes. Only nodes themselves may be changed.`,
    ...
    testCases: [
      ...
      { input: '[1,2,3,4,5,6]', expectedOutput: '[1,6,2,5,3,4]', isHidden: true },
...
A binary tree's **maximum depth** is the number of nodes along the longest path from the root node down to the farthest leaf node.`,
    ...
    testCases: [
      ...
      { input: '[1,null,2,null,3,null,4]', expectedOutput: '4', isHidden: true },
...
Inverting a binary tree means swapping the left and right children of all nodes in the tree.`,
    ...
    testCases: [
      ...
      { input: '[]', expectedOutput: '[]', isHidden: true },
      { input: '[1]', expectedOutput: '[1]', isHidden: true },
      { input: '[1,2]', expectedOutput: '[1,null,2]', isHidden: true },
  ...
  },
  {
    ...
    testCases: [
      ...
      { input: '[]', expectedOutput: '[]', isHidden: true },
      { input: '[1,2,3]', expectedOutput: '[[1],[2,3]]', isHidden: true },
      { input: '[1,2,3,4,5,6,7]', expectedOutput: '[[1],[2,3],[4,5,6,7]]', isHidden: true },
      { input: '[1,null,2,3]', expectedOutput: '[[1],[2],[3]]', isHidden: true },
